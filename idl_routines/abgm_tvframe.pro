...
plot,XRANGE,YRANGE,/nodata,xstyle=xstyle or 4,ystyle=ystyle or 4    $
     ...
     ,  SUBTITLE=SUBTITLE , CHARTHICK=CHARTHICK      $
     ,  TICKLEN=TICKLEN,CHARSIZE=CHARSIZE , THICK=THICK   $
     ,  color=!p.background
;
...
tvlct, abgm_col1, abgm_col2, abgm_col3, /get
LOADCT, 0,/sil
if keyword_set(bar) then begin
...
tvlct, abgm_col1, abgm_col2, abgm_col3
return
;
