PROGRAM VFISV
  ...
  INTEGER(kind=2), DIMENSION(1) :: DIMS7
  INTEGER(kind=2), DIMENSION(2) :: DIMS8
  INTEGER(kind=2), DIMENSION(1) :: DIMS9
  INTEGER(kind=2), DIMENSION(1) :: DIMS10
...
!!!print*,'List Free Params: ',LIST_FREE_PARAMS(:)
    ...
    READ(1) NDIMS6
    READ(1) DIMS6
    !ALLOCATE(POL_LOW(DIMS6(1)))
    !POL_LOW = 0.0D0
    READ(1) POL_LOW
!!!print*,NDIMS6
!!!print*,DIMS6
!!!print*,'Lower Polarization: ',POL_LOW

    READ(1) NDIMS7
    READ(1) DIMS7
    !ALLOCATE(POL_UPP(DIMS7(1)))
    !POL_UPP = 0.0D0
    READ(1) POL_UPP
!!!print*,NDIMS7
!!!print*,DIMS7
!!!print*,'Upper Polarization: ',POL_UPP
